    ...
    return( <>
        ...
        <form onSubmit={handleSubmit} ref={formRef} className="form">
            <Grid container spacing={4}>
                <Grid size={4}>
                    <label className="outlineText" htmlFor="geographic_department">Geographic Department:</label>
                </Grid>
                <Grid size={8}>
                    <TextField id="geographic_department" name="geographic_department" type="text" size="small" required={true}/>
                </Grid>
                <Grid size={4}>
                    <label className="outlineText" htmlFor="total_capacity">Total Capacity</label>
                </Grid>
                <Grid size={8}>
                ...
                <Grid size={4}>
                    <label className="outlineText" htmlFor="short_name">Name</label>
                </Grid>
                <Grid size={8}>
                    <TextField id="short_name" name="short_name" type="text" size="small" required={true}/>
                </Grid>
                <Grid size={4}><label className="outlineText" htmlFor="cold_capacity">Cold Capacity</label>
                </Grid>
                <Grid size={8}><TextField id="cold_capacity" name="cold_capacity" type="number" size="small"/>
                </Grid>
                <Grid size={4}><label className="outlineText" htmlFor="freezing_capacity">Freezing Capacity</label>
                </Grid>
                <Grid size={8}><TextField id="freezing_capacity" name="freezing_capacity" type="number" size="small"/>
                </Grid>
                <Grid size={4}><label className="outlineText" htmlFor="room_temp_capacity">Room Temperature Capacity</label>
                </Grid>
                <Grid size={8}><TextField id="room_temp_capacity" name="room_temp_capacity" type="number" size="small"/>
                </Grid>
                <Grid size={4}><label className="outlineText" htmlFor="longitude">Longitude</label>
                </Grid>
                <Grid size={8}><TextField id="longitude" name="longitude" type="number" size="small"/>
                </Grid>
                <Grid size={4}><label className="outlineText" htmlFor="latitude">Latitude</label>
                </Grid>
                <Grid size={8}><TextField id="latitude" name="latitude" type="number" size="small"/>
                </Grid>
                <Grid size={4}><label className="outlineText" htmlFor="address">Address</label>
                </Grid>
                <Grid size={8}><TextField id="address" name="address" type="text" size="small"/>
                </Grid>
                <Grid size={4}><label className="outlineText" htmlFor="state">State</label>
                </Grid>
                <Grid size={8}><TextField id="state" name="state" type="text" size="small"/>
                </Grid>
                <Grid size={4}><label className="outlineText" htmlFor="zip_code">Zip Code</label>
                </Grid>
